...
namespace Lab13
{
    ...
    {// array with answers to the question
        ...
        {
            Loaddata(index); button3.Enabled = true;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            index++;//увелить индек, чтобы следующая загрузка пошла с 
            button2.Enabled = true;
        }

        private void button3_Click(object sender, EventArgs e)
        {
            Text = "Вы набрали " + result.ToString() + " баллов";//вывод данных в заголовок формы
        }
